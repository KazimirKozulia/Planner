...
public enum L10n {
  ...
  public enum FullName {
    public enum Placeholder {
      /// Введите полное имя
      public static let text = L10n.tr("Localizable", "fullName.placeholder.text", fallback: "Введите полное имя")
    }
  }
  public enum General {
    /// Или
  ...
  public enum Login {
    public enum Button {
      /// Войти с помощью
      public static let title = L10n.tr("Localizable", "login.button.title", fallback: "Войти с помощью")
    }
    public enum Label {
      /// Л
      public static let firstLetter = L10n.tr("Localizable", "login.label.firstLetter", fallback: "Л")
      /// огин
      public static let halfText = L10n.tr("Localizable", "login.label.halfText", fallback: "огин")
    }
  }
  public enum Logout {
    public enum Button {
  ...
  public enum SignIn {
    public enum Button {
      /// Войти
      public static let title = L10n.tr("Localizable", "signIn.button.title", fallback: "Войти")
    }
  }
  public enum SignUp {
    public enum Button {
