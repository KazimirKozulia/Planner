...
class SignUpViewController: UIViewController {
    ...
    @IBOutlet var profileTextField: SignTextField!
...
//                    let _ = confirmPassword == password
    ...
    func keyboardWillChangeFrame(_ notification: NSNotification) {
       ...
       let textFields = [profileTextField!, emailTextField!, passwordTextField!, confirmPasswordTextField!]
